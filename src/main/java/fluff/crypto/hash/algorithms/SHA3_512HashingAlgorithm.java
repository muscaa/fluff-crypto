...
/**
 * An implementation of the {@link IHashingAlgorithm} interface for the SHA3 512 hashing algorithm.
 */
public class SHA3_512HashingAlgorithm implements IHashingAlgorithm {
	
	private static final MessageDigest md = CryptoUtils.getMessageDigest("SHA3-512");
